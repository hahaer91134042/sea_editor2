                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="col-2" scope="col">{{ $t('describe') }}</th>
                                ...
                                <td>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder=""
                                            v-model="data.name" @input="onItemChange(data)" />
                                        <div class="form-check mt-1">
                                            <input class="form-check-input" type="checkbox"
                                                :checked="data.is_ChangeID == 1" @change="onGoldChange(data)" />
                                            <label class="form-check-label" for=""> {{ $t('gold_turns_wild') }}
                                            </label>
                                        </div>
                                        <div class="form-check mt-1">
                                            <input class="form-check-input" type="checkbox"
                                                :checked="data.disable_copy == 1" @change="onCopyChange(data)" />
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                <input type="text" class="form-control"
                                                                    @input="onItemChange(data)" placeholder=""
                                                                    v-model="con.param" />
                                                            </div>
                                                        </td>
                                                    </tr>
...
<script setup>
import { inject, reactive, ref, toRefs, watch, computed, getCurrentInstance } from 'vue'
...
function onGoldChange(v) {
    //console.log(`gold 1 change->${v.jsonString()}`)
    v.is_ChangeID = v.is_ChangeID == 1 ? 0 : 1
    //console.log(`gold 2 change->${v.jsonString()}`)
    onItemChange(v)
}

function onCopyChange(v) {
    //console.log(`gold 1 change->${v.jsonString()}`)
